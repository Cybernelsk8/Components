...
<div x-show="open"  class="inset-0 fixed h-screen bg-gray-900 bg-opacity-40 z-20 overflow-y-auto">
    <div class="relative flex justify-center mt-6">
        <div x-transition  {{ $attributes->merge(['class' => 'border-'.$color.'-600 bg-white mx-4  max-w-'.$size.' min-w-min rounded-lg shadow-lg border-2 overflow-hidden']) }} >
